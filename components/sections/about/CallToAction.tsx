        ...
        <div className={styles.textContainer}>
          <div className={styles.heading}>
            <h2 className={styles.r3}>
              Ready to Get Paid in Your Chats?
            </h2>
          </div>
          <div className={styles.paragraph}>
            <p className={styles.r5}>
              Create your store, connect your catalog, and start sending checkout links to every customer you already talk to.
            </p>
          </div>
        </div>
        <div className={styles.subContainer}>
          ...
          <div className={styles.r7}>
            <div className={styles.image3}>
              ...
              <Link className={styles.circleWrap} href="/login">
                  ...
                  <div className={styles.big}>
                    ...
                    <div className={styles.r35}>
                      <div className={styles.r36}>
                        <CircularText className={styles.r37} text="Start Selling | Start Selling | Start Selling | Start Selling" />
                      </div>
                    </div>
                  </div>
                </div>

              ...
              <div className={styles.textContainer}>
                ...
                <div className={styles.paragraph}>
                  <p className={styles.r14}>
                    We build tools that let merchants accept card payments through a secure link, right inside the WhatsApp conversations they already have.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className={styles.container2}>
                  <div className={styles.paragraph2}>
                    <p className={styles.r27}>
                      To turn every WhatsApp conversation into a paid order, helping sellers get paid without building a storefront first.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className={styles.r16}>
              <div className={styles.medium} data-border="true">
                ...
                <div className={styles.container2}>
                  <div className={styles.paragraph2}>
                    <p className={styles.r27}>
                      To become the fastest, most trusted way for chat-based sellers everywhere to take payments.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className={styles.container4}>
                  <div className={styles.paragraph3}>
                    <p className={styles.r35}>
                      Great product work happens when our merchants and our team shape the roadmap together, one payment flow at a time.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className={styles.r28}>
              <div className={styles.medium2} data-border="true">
                ...
                <div className={styles.container4}>
                  <div className={styles.paragraph3}>
                    <p className={styles.r35}>
                      At Chat to Pay, we are committed to staying at the forefront of chat commerce and hosted payments.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className={styles.r28}>
              <div className={styles.medium2} data-border="true">
                ...
                <div className={styles.container4}>
                  <div className={styles.paragraph3}>
                    <p className={styles.r35}>
                      We uphold secure, PCI-compliant payments and honest pricing in everything we ship for merchants.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className={styles.r28}>
              <div className={styles.medium2} data-border="true">
                ...
                <div className={styles.container4}>
                  <div className={styles.paragraph3}>
                    <p className={styles.r35}>
                      We are dedicated to outcomes merchants can measure: orders placed, payments settled, and storefronts growing.
                    </p>
                  </div>
                </div>
              </div>

                ...
                <div className={styles.textContainer}>
                  ...
                  <div className={styles.paragraph}>
                    <p className={styles.r30}>
                      Have a question about payments, or ready to move your sales into WhatsApp? Write to us and we will help you get set up.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className={styles.container5}>
                    ...
                    <div className={styles.text3}>
                      <p className={styles.r62}>
                        <a className={styles.r63} href="mailto:hello@chattopay.example" target="_blank" rel="noreferrer">
                          hello@chattopay.example
                        </a>
                      </p>
                    </div>
                  </div>
